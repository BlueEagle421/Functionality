...
public class InfernalSack {
    ...
    public InfernalSack(ForgeConfigSpec.Builder builder) {
        ...
        dropXPChance = builder
                .comment("Chance for dropping experience after opening the sack (1 = 100% chance).")
                .defineInRange("dropXPChance", 1.0D, 0.0D, 1.0D);

        baseXPValue = builder
                .comment("The base amount of experience given from sack.")
                .defineInRange("baseXPValue", 5, 0, Integer.MAX_VALUE);
